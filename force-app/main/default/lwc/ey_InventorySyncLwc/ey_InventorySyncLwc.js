...
import InventorySync from '@salesforce/apex/EYI_InventorySyncLwcController.InventorySync';
...
export default class Ey_InventorySyncLwc extends LightningElement {
...
@wire(CurrentPageReference)
   setPageReference(currentPageReference) {
    ...
    @wire(getSyncValue, { projectId: '$recordId', lwc: 'Inventory' })
