...
import pricingDataSync from '@salesforce/apex/EYI_PricingCallout.pricingDataSync';
...
export default class EYI_PricingSyncLwc extends LightningElement {
   ...
   setPageReference(currentPageReference) {
      ...
      validateBrokerData(){
        ...
        .then(result => {
            ...
            if (result.type.toLowerCase().includes('s') && !this.isSync) {
    ...
    async synBrokerDataCall(event){
     ...
     @wire(getSyncValue, { projectId: '$recordId', lwc:'Pricing' })
