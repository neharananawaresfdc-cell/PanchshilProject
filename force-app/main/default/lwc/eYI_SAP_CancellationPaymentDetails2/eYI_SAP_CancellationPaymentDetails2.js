...
export default class EYI_SAP_CancellationPaymentDetails2 extends NavigationMixin(LightningElement) {
...
//Add these new handler methods
    ...
    mainRowCalculation(){
        ...
        this.totalReceivedAmount = this.REFUND_P;
        ...
        this.totalAmountCharged = parseFloat(this.Demand_CTC)+ parseFloat(this.DEBIT_CTC) + parseFloat(this.CREDIT_CTC) + parseFloat(this.totalInterestCharged) + parseFloat(this.totaBrokerageCharged);
        ...
        console.log('this.totalRefundtoCustomer : '+this.totalRefundtoCustomer);
...
fetchQuoteDetails() {
 ...
 parseDecimal(input) {
  ...
  return isNaN(number) ? null : number;
    ...
    handleTDSAmount(event){
        this.tdsAmount = event.target.value;
        console.log('this.tdsAmount : '+this.tdsAmount);
    }
